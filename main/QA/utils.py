...
class SquadExample(object):
    """
    A single training/test example for the Squad data.
...
class InputFeatures(object):
    """A single set of features of model."""
...
def squad_examples_to_features(example, tokenizer, max_seq_length,
    ...
    """Loads a model file into a list of `InputBatch`s."""
...
def get_final_text(pred_text, orig_text, do_lower_case, verbose_logging=False):
    ...
    # When we created the model, we kept track of the alignment between original
